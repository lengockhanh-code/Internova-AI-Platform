...
export default function LecturerReportsPage() {
  ...
  async function handleReview() {
    ...
    if (decision === "APPROVED" && (numericScore === null || numericScore < 0 || numericScore > 100)) {
      setReviewMessage("Điểm duyệt phải nằm trong khoảng 0 đến 100.");
      return;
    }
