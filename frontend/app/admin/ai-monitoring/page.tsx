    ...
    >
      ...
      {state.loading && !o ? (
        ...
        <div className={styles.emptyBox}>
          Chưa có dữ liệu. Hệ thống sẽ tự động
          cập nhật khi có trace từ chatbot.
        </div>
      ) : (
        <>
          {o.data_truncated && (
            <div className={styles.warningBox}>
              Dữ liệu bị giới hạn bởi
          ...
          <div className={styles.grid4}>
            ...
            <MetricCard
              label="Active Users"
              value={formatNumber(
                o.requests?.active_users,
              )}
              icon={icons.Users}
              note={`${formatNumber(
                o.requests?.active_sessions,
              )} sessions`}
            />
          </div>
          ...
          <div className={styles.grid2}>
            <Panel
              ...
              subtitle={`Request buckets · ${range}`}
              right={
                <span
                  className={
                    styles.livePill
          ...
          <div className={styles.grid2}>
            <Panel
              title="AI Quality"
              subtitle="Score thực tế theo từng trace"
            >
              <QualityBar
            ...
            <Panel
              ...
              subtitle="Generation + embedding observations"
              right={
                <CircleDollarSign
                  size={18}
                />
          ...
          <div className={styles.grid2}>
            <Panel
              title="RAG Pipeline"
              subtitle="P95 latency theo stage"
            >
              <PipelineRows
                rows={o.pipeline ?? []}
              />
            ...
            <Panel
              ...
              subtitle="Sức khỏe suy ra từ telemetry gần đây"
            >
              <div className={styles.list}>
          ...
          <Panel
            ...
            subtitle="Những phần đang được theo dõi trong chatbot production"
            right={<Server size={18} />}
          >
            <div className={styles.grid4}>
              <MetricCard
                label="Tracing"
